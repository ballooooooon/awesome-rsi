<div align="center">
  ...
  <p>A curated list of literature, open-source projects, and products on<br>self-evolving agents &amp; recursive self-improvement (RSI).</p>
  <p><b>English</b> · <a href="README_cn.md">中文</a></p>
</div>

---

This list covers research and systems in which some component of an AI system is improved through iteration — from single-response self-critique to agents that rewrite their own code. The list is organized by **object of evolution** into six layers, each annotated with its characteristic failure mode. The remaining sections (algorithmic foundations, self-evaluation, safety, benchmarks) cut across layers, followed by frameworks, products, and historical foundations.

## Contents

- [Surveys](#surveys)
- [L1 Artifact Layer](#l1-artifact-layer)
- [L2 Model Layer](#l2-model-layer)
- [L3 Context & Memory Layer](#l3-context--memory-layer)
- [L4 Harness & Self-Modification Layer](#l4-harness--self-modification-layer)
- [L5 Meta-Improvement Layer](#l5-meta-improvement-layer)
- [L6 Criterion Layer](#l6-criterion-layer)
...
Cross-cutting overviews of self-evolving agents and recursive self-improvement.
...
- [A Systematic Survey of Self-Evolving Agents: From Model-Centric to Environment-Driven Co-Evolution](https://doi.org/10.36227/techrxiv.177203250.05832634/v2) - Taxonomy spanning from model-centric to environment-driven co-evolution. (TechRxiv 2026)

## L1 Artifact Layer

The object of evolution is the system's output — from single responses to persistent artifacts. Characteristic failure mode: **self-confirmation loop** — iteration without an external signal is rewriting, not progress.

### Within-Task Self-Refinement (No Persistence)

Within-task loops: the model critiques and rewrites its own output within one session, leaving nothing behind.
...
- [Large Language Models Cannot Self-Correct Reasoning Yet](https://arxiv.org/abs/2310.01798) - Intrinsic self-correction without external feedback degrades reasoning; the negative-result baseline for this layer. (ICLR 2024)
...
- [AlphaEvolve: A Coding Agent for Scientific and Algorithmic Discovery](https://arxiv.org/abs/2506.13131) - From Google DeepMind: combines LLM-ensemble sampling, automated evaluation, and evolutionary search for algorithm discovery and infrastructure optimization. (arXiv 2025) [[problems]](https://github.com/google-deepmind/alphaevolve_repository_of_problems)
- [ShinkaEvolve: Towards Open-Ended and Sample-Efficient Program Evolution](https://arxiv.org/abs/2509.19349) - Sample-efficiency-focused program evolution framework reaching comparable results under tight evaluation budgets. (ICLR 2026) [[code]](https://github.com/SakanaAI/ShinkaEvolve)
...
- [Evolutionary Optimization of Model Merging Recipes](https://arxiv.org/abs/2403.13187) - From Sakana AI: evolves combinations of open-source models in parameter space and data-flow space. (arXiv 2024)
- [The AI Scientist: Towards Fully Automated Open-Ended Scientific Discovery](https://arxiv.org/abs/2408.06292) - From Sakana AI: the artifact is the research itself — automated idea generation, experiments, paper writing, and reviewing in a full loop. (arXiv 2024) [[code]](https://github.com/SakanaAI/AI-Scientist)

## L2 Model Layer

The object of evolution is the model's own parameters: weights updated with self-generated data, rewards, or reasoning traces. Characteristic failure mode: **model collapse** — iterated training on self-generated data erodes diversity.

### Self-Training & Self-Rewarding

The model generates its own training signal — data, preferences, or rewards — and updates its weights on it.

- [Self-Instruct: Aligning Language Models with Self-Generated Instructions](https://arxiv.org/abs/2212.10560) - Bootstraps instruction data from the model itself, filters it, then fine-tunes. (ACL 2023)
- [Large Language Models Can Self-Improve](https://arxiv.org/abs/2210.11610) - Uses high-confidence self-generated answers as pseudo-labels to iteratively fine-tune on reasoning tasks. (EMNLP 2023)
...
Reasoning ability is bootstrapped from the model's own rationales rather than human demonstrations.
...
## L3 Context & Memory Layer

The object of evolution is the agent's experience, skills, and context rather than its weights: append, retrieve, consolidate, forget. Characteristic failure mode: **context collapse & memory poisoning** — accumulation that degrades rather than improves.
...
- [Voyager: An Open-Ended Embodied Agent with Large Language Models](https://arxiv.org/abs/2305.16291) - Minecraft lifelong-learning agent: automatic curriculum + a continuously expanding library of reusable skills. (TMLR 2024) [[code]](https://github.com/MineDojo/Voyager)
...
## L4 Harness & Self-Modification Layer

The object of evolution is the agent's own prompts, tools, workflows, and code: modify, version, roll back. Characteristic failure mode: **scaffold overfitting** — structural changes tuned to the evaluation environment.

### Self-Modifying Agents

Agents edit their own source code and keep a lineage of validated versions.

- [Darwin Gödel Machine: Open-Ended Evolution of Self-Improving Agents](https://arxiv.org/abs/2505.22954) - Agents modify their own code; benchmark-validated improvements enter an open-ended archive forming an expanding family tree; SWE-bench 20% → 50%. (ICLR 2026) [[code]](https://github.com/jennyzzt/dgm)
...
The search space is prompts, workflows, and agent architectures expressed as code.
...
The object of evolution is the judge: evaluators, verifiers, scoring rubrics. Characteristic failure mode: **criterion drift** — the judge gets pulled off course by the systems it judges during co-evolution.
...
- [Language Models (Mostly) Know What They Know](https://arxiv.org/abs/2207.05221) - Anthropic study of models' calibration in assessing the correctness of their own answers. (arXiv 2022)
...
What can go wrong when systems change themselves: reward tampering, goal drift, deceptive alignment, and the oversight problem.
...
- [Scalable Agent Alignment via Reward Modeling](https://arxiv.org/abs/1811.07871) - Recursive reward modeling: supervising agents beyond what humans can directly evaluate. (arXiv 2018)
...
- [Constitutional AI: Harmlessness from AI Feedback](https://arxiv.org/abs/2212.08073) - Anthropic's approach: scales oversight with written principles and model-generated critiques while retaining explicit behavioral constraints. (arXiv 2022)
...
- [Sleeper Agents: Training Deceptive LLMs that Persist Through Safety Training](https://arxiv.org/abs/2401.05566) - From Anthropic: deceptive policies can remain hidden through standard safety training. (arXiv 2024)
...
Task suites used to test whether claims of self-improvement hold up.
...
- [MLE-bench](https://arxiv.org/abs/2410.07095) - OpenAI's end-to-end ML engineering evaluation across 75 Kaggle competitions. (ICLR 2025)
...
Runnable implementations, from evolutionary coding agents to self-optimizing LM pipelines.
...
Commercial efforts built around self-evolving agent technology.
...
Pre-LLM ideas that anticipated recursive self-improvement.

- [Gödel Machines: Self-Referential Universal Problem Solvers](https://people.idsia.ch/~juergen/goedelmachine.html) - Fully self-referential machines that rewrite themselves after proving that a modification improves expected utility. The theoretical prototype of RSI. (Schmidhuber, 2006)
- [POWERPLAY: Training an Increasingly General Problem Solver](https://arxiv.org/abs/1112.5309) - Alternates inventing new tasks and modifying the solver, expanding a verified capability set over time. (arXiv 2011)
...
Contributions are welcome. Each entry should include a brief description and a valid source link.
